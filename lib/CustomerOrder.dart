...
class CustomerOrder extends StatefulWidget {
 ...
 @override
  State<CustomerOrder> createState() => CustomerOrderpvt();
...
class CustomerOrderpvt extends State<CustomerOrder> {
...
return   Scaffold(
  ...
  appBar: AppBar(title:
      ...
      const Center(child: Text("Booking History", textAlign: TextAlign.center,)),
